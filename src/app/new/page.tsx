  ...
  return (
    ...
    >
        ...
        <Grid   container>
          <Grid item xs={12} sx={{maxWidth:'lg',py:{xs:12,md:20}}}
           ...
           <Box sx={{width:'100px',height:'100px'}} className='rounded auto center'>
            <img src="https://ucarecdn.com/be805fa6-ecca-4d06-a2b1-d28f6001c38c/anehorsh.jpg" alt="" className="img rounded" />
           </Box>
            ...
            <Typography component='p' className='text-center color3' 
        ...
        <Grid   container>
          <Grid item xs={12} sx={{maxWidth:'lg',py:{xs:8,md:12}}}
           className='auto white row justify-evenly w100 flex  '>
            <Box>
            <Typography component='h1' className='text-center color2' sx={{
              lineHeight:'0.8',
            fontWeight:800,fontSize:{xs:'3.15em',md:'5em'}}}>
             15+
            </Typography>
            <Typography component='h1' className='text-center color3' 
            sx={{fontSize:{xs:'1.1em',md:'1.4em'},maxWidth:{xs:'500px',md:'800px'},fontWeight:300}}>
             unique customers
            </Typography>
            </Box>
    ...
    {`We've been working for several years to build a portfolio that truly reflects our diversity.`}
        ...
        className='bg4 relative flex center text-center  items-center col'>
            ...
            <Box sx={{width:{xs:'170px',md:'350px'},right:'-3%'
            ,top:{xs:'-15%'}
            ,height:{xs:'170px',md:'350px'}}}
            className='absolute'
            >
              <img
            ...
            <Box sx={{width:{xs:'100px',md:'350px'},left:'-3%'
            ,top:{xs:'-7%'}
          ...
          <Box className='flex col center items-center'>
